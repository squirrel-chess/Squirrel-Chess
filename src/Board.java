		...
		for (Position pos : p.getMoveSet()) {
			...
			if (whiteTurn) {
				if ((pos.getRow() + pos.getCol()) % 2 == 1) {
					squares[pos.getRow()][pos.getCol()].setBackground(new Color(119, 191, 111));
				} else {
					squares[pos.getRow()][pos.getCol()].setBackground(new Color(159, 255, 148));
				}
			} else {
				if ((pos.getRow() + pos.getCol()) % 2 == 1) {
					squares[pos.getRow()][pos.getCol()].setBackground(new Color(79, 128, 74));
				} else {
					squares[pos.getRow()][pos.getCol()].setBackground(new Color(119, 191, 111));
				}
			}
